...
//    $target_path = $GLOBALS['res_dir'];
//    $file_name = basename($_FILES['uploadedfile']['name']);
    $file_name = 'alterego_first_35.csv';
    $source_file = "D:/Documents/work/Seduce/alterego_first_35.csv";
    $target_path = $_SERVER['DOCUMENT_ROOT'] . '/ImagesFromCSV/resources/alterego_first_35.csv';
...
function uploadCSV_OLD() {//$file_name) { // ***USING ??
//    if (empty($file_name)) {
//        return FALSE;
//    }
    $target_path = $GLOBALS['res_dir'];
